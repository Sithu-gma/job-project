<?php 
    ...
    $datas = new Employers(new MySQL());
    $id=$_GET['id'];
    $data=$datas->getDetail($id);
    $all = $posts->getPost(); 
  ?>
<!doctype html>
<html lang="en">
            ...
            <div class="container >
              ...
              <div class="row featurette">
                <form action="../_actions/employer-upload.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">                       
                        <input type="text" name="name" value="<?=$data->name?>" class="form-control" id="formGroupExampleInput" placeholder=" Input Your Name">
                    </div>                                     
                    <div class="mb-3">                       
                        <input type="phone" name="phone" value="<?=$data->phone?>" class="form-control" id="formGroupExampleInput" placeholder=" Input Your Phone">
                    </div>
                    <div class="mb-3">                       
                        <Input type="email" name="email" value="<?=$data->email?>" class="form-control" id="formGroupExampleInput" placeholder=" Input Your Email">
                    </div>
                    <div class="mb-3">                       
                        <input type="password" name="password" value="<?=$data->password?>" class="form-control" id="formGroupExampleInput" placeholder=" Input Your Password">
                    </div>
                    <div class="mb-3">                       
                        <input type="text" name="address" value="<?=$data->address?>" class="form-control" id="formGroupExampleInput" placeholder=" Input Your Address">
                    </div>
                    <div class="mb-3">                       
                    ...
                    <div class=" mb-3">
                        <?php if($data->logo): ?>
                            ...
                            src="../_actions/photo/<?= $data->logo ?>"
                            alt="Employer Photo" width="200"> 
