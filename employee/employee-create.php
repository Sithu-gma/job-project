       ...
       <hr>
            ...
            <div class="container >
              ...
              <div class="row featurette">
                <form action="../_actions/employee-upload.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">                       
                        <input type="text" name="name" class="form-control" id="formGroupExampleInput" placeholder=" Input Your Name">
                    </div>
                    <div class="mb-3">                       
                        <input type="text" name="nrc" class="form-control" id="formGroupExampleInput" placeholder=" Input Your National Identity">
                    </div>
                    ...
                    <div class="mb-3">                       
                        <input type="age" name="age" class="form-control" id="formGroupExampleInput" placeholder=" Input Your Age">
                    </div>
